...
extern BOOL   nc16ss_Check_Stereo(uint mixmode, uint format, uint flags);
extern BOOL   nc16ss_Check_StereoInterp(uint mixmode, uint format, uint flags);
extern BOOL   nc16ss_Check_Mono(uint mixmode, uint format, uint flags);
extern BOOL   nc16ss_Check_MonoInterp(uint mixmode, uint format, uint flags);

extern BOOL   nc16_Check_Stereo(uint mixmode, uint format, uint flags);
extern BOOL   nc16_Check_StereoInterp(uint mixmode, uint format, uint flags);
extern BOOL   nc16_Check_Mono(uint mixmode, uint format, uint flags);
extern BOOL   nc16_Check_MonoInterp(uint mixmode, uint format, uint flags);
