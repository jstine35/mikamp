...
extern BOOL   nc8ss_Check_Stereo(uint mixmode, uint format, uint flags);
extern BOOL   nc8ss_Check_StereoInterp(uint mixmode, uint format, uint flags);
extern BOOL   nc8ss_Check_Mono(uint mixmode, uint format, uint flags);
extern BOOL   nc8ss_Check_MonoInterp(uint mixmode, uint format, uint flags);

extern BOOL   nc8_Check_Stereo(uint mixmode, uint format, uint flags);
extern BOOL   nc8_Check_StereoInterp(uint mixmode, uint format, uint flags);
extern BOOL   nc8_Check_Mono(uint mixmode, uint format, uint flags);
extern BOOL   nc8_Check_MonoInterp(uint mixmode, uint format, uint flags);
