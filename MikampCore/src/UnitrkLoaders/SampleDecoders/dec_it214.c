...
------------------------------------------
 ...
 Original asm code by Jeffrey Lim.
 C port courtesy of Justin Frankel.
 Formatting, API refinements, and optimizations by Jake Stine.
...
// create a 32k loading buffer for reading in the compressed frames of samples.
// Air notes: I had to change this to 36000 bytes to make room for very rare samples
