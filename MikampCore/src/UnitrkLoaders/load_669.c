...
------------------------------------------
 load_669.c
  ...
  Tran's 669 module loader.  It doesn't work very well because Tran's brain has a method of
  twisted logic beyond the extraordinary, and a lacking ability to document it.
...
void *S69_Init(void)
{
    return _mmobj_allocblock( NULL, S69HEADER );
}
