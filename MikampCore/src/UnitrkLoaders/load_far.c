...
------------------------------------------
 load_far.c
  ...
  Farandole (FAR) module loader.  As I recall this one works well (except I haven't had a
  .FAR module to test it with for years).


 [TODO] : Needs updated to utilize the new MLOADER API.
*/
